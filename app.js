...
var allStores = [PikePlace,SeaTac,Southcenter,BellSquare,Alki];
...
for(var checkForNewStore = 0; checkForNewStore < storeArray.length; checkForNewStore++)

  if (this.shopname != storeArray[i])
